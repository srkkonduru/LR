# 1 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s04_cancel_ticket\\\\combined_WT_S04_Cancel_Ticket.c"
...
# 1 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s04_cancel_ticket\\\\combined_WT_S04_Cancel_Ticket.c" 2
...
# 2 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s04_cancel_ticket\\\\combined_WT_S04_Cancel_Ticket.c" 2
...
int i;
char *temp;
# 3 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s04_cancel_ticket\\\\combined_WT_S04_Cancel_Ticket.c" 2
...
# 4 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s04_cancel_ticket\\\\combined_WT_S04_Cancel_Ticket.c" 2
...
Action()
{
	...
	web_url("index.htm", 
		...
		if(i>0)
		{
			...
			lr_end_transaction("S04_WT_Cancel_T01_LaunchPage", 0);
			
		}
		else
		{
	    	lr_output_message("Launch_Page_Failed");			
	    	lr_end_transaction("S04_WT_Cancel_T01_LaunchPage", 1);
		}
	...
	i=atoi(lr_eval_string("{LoginC}"));
		...
		if(i>0)
		{
			...
			lr_end_transaction("S04_WT_Cancel_T02_LoginPage", 0);
			
		}
		else
		{
		lr_output_message("Login_Page_Failed");			
		lr_end_transaction("S04_WT_Cancel_T02_LoginPage", 1);
		}
	...
	i=atoi(lr_eval_string("{itinerary}"));
		...
		if(i>0)
		{
			...
			lr_end_transaction("S04_WT_Cancel_T03_itinerary", 0);
			
		}
		else
		{
		lr_output_message("itinarery_Page_Failed");			
		lr_end_transaction("S04_WT_Cancel_T03_itinerary", 1);
		}
	...
	i=atoi(lr_eval_string("{cancel}"));
		...
		if(i>0)
		{
			...
			lr_end_transaction("S04_WT_Cancel_T04_cancel", 0);
			
		}
		else
		{
		lr_output_message("Cancel_Page_Failed");			
		lr_end_transaction("S04_WT_Cancel_T04_cancel", 1);
		}
	...
	if(i>0)
	{
		...
		lr_end_transaction("WT_S04_Cancel_T05_LogOff_Page", 0);
}
else
{
		lr_output_message("LogOff_Page_Failed");	  	 
		lr_end_transaction("WT_S04_Cancel_T05_LogOff_Page", 1);
	  	lr_exit(5,1);
...
# 5 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s04_cancel_ticket\\\\combined_WT_S04_Cancel_Ticket.c" 2
...
# 6 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s04_cancel_ticket\\\\combined_WT_S04_Cancel_Ticket.c" 2
