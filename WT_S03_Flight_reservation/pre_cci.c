# 1 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s03_flight_reservation\\\\combined_WT_S03_Flight_reservation.c"
...
# 1 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s03_flight_reservation\\\\combined_WT_S03_Flight_reservation.c" 2
...
# 2 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s03_flight_reservation\\\\combined_WT_S03_Flight_reservation.c" 2
...
int i,j,k;
char *temp,*temp1,*temp2,*token;
int thinktime=10;
# 3 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s03_flight_reservation\\\\combined_WT_S03_Flight_reservation.c" 2
...
# 4 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s03_flight_reservation\\\\combined_WT_S03_Flight_reservation.c" 2
...
Action()
{
   ...
   if (i>0)
   {
     ...
     lr_end_transaction("WT_S03_FB_T01_Launch_page", 0);
  }
  else
  {
  	  lr_output_message("Login_Page_Failed");
  	  lr_end_transaction("WT_S03_FB_T01_Launch_page", 1);
  	  lr_exit(5,1);
	...
	if(i>0)
	{
		...
		lr_end_transaction("WT_S03_FB_T02_Login_page", 0);
}
else
{
		lr_output_message("Login_Page_Failed");	  	 
		lr_end_transaction("WT_S03_FB_T02_Login_page", 1);
	  	lr_exit(5,1);
...
# 166 "Action.c"
	...
	if(i>0)
	{
		...
		lr_end_transaction("WT_S03_FB_T03_Find_Flight", 0);
}
else
{
		lr_output_message("Find_Flight_Page_Failed");	  	 
		lr_end_transaction("WT_S03_FB_T03_Find_Flight", 1);
	  	lr_exit(5,1);
...
web_reg_save_param("Flight",
 ...
 "LAST");
	...
	if(i>0)
	{
		...
		lr_end_transaction("WT_S03_FB_T04_Select_Flight", 0);
}
else
{
		lr_output_message("Select_Flight_Page_Failed");	  	 
		lr_end_transaction("WT_S03_FB_T04_Select_Flight", 1);
	  	lr_exit(5,1);
...
lr_save_string(token,"FlightSelected");
	...
	if(i>0)
	{
		...
		lr_end_transaction("WT_S03_FB_T05_Payment_dtls", 0);
}
else
{
		lr_output_message("Payment_Page_Failed");	  	 
		lr_end_transaction("WT_S03_FB_T05_Payment_dtls", 1);
	  	lr_exit(5,1);
	...
	if(i>0)
	{
		...
		lr_end_transaction("WT_S03_FB_T06_Invoice_Page", 0);
}
else
{
		lr_output_message("Invoice_Page_Failed");	  	 
		lr_end_transaction("WT_S03_FB_T06_Invoice_Page", 1);
	  	lr_exit(5,1);
	...
	if(i>0)
	{
		...
		lr_end_transaction("WT_S03_FB_T07_Book_Another_Page", 0);
}
else
{
		lr_output_message("Book_Another_Page_Failed");	  	 
		lr_end_transaction("WT_S03_FB_T07_Book_Another_Page", 1);
	  	lr_exit(5,1);
	...
	if(i>0)
	{
		...
		lr_end_transaction("WT_S03_FB_T08_LogOff_Page", 0);
}
else
{
		lr_output_message("LogOff_Page_Failed");	  	 
		lr_end_transaction("WT_S03_FB_T08_LogOff_Page", 1);
	  	lr_exit(5,1);
...
# 5 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s03_flight_reservation\\\\combined_WT_S03_Flight_reservation.c" 2
...
# 6 "c:\\users\\srkko\\documents\\vugen\\scripts\\wt_s03_flight_reservation\\\\combined_WT_S03_Flight_reservation.c" 2
